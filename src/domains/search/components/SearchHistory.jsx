...
import { getSearchHistory, clearSearchHistory, removeSearchFromHistory } from '../../../shared/utils/searchHistory'
...
const SearchHistory = ({ onSelectSearch, onClear, refreshTrigger }) => {
  ...
  const handleRemove = async (e, id) => {
    e.stopPropagation()
    try {
      const updatedHistory = await removeSearchFromHistory(id)
