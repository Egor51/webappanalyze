...
import { useTopInvestments, useInvestmentsByBudget } from '../hooks'
import { validateInvestmentOptionsArray, getInvestmentDataStats } from '../../../shared/utils/investmentDataValidator'
import { matchesMandate, setMandateMatchCount, getMandates, getMandateMatchCount } from '../../../shared/utils/mandateStorage'
  ...
  useEffect(() => {
    const handleProToggle = (e) => {
      if (e.key === 'p' && e.ctrlKey && e.shiftKey) {
        ...
        // PRO статус переключен - логирование не требуется
      }
    }
  ...
  const loadBestOptions = useCallback(async () => {
    ...
    try {
      if (USE_MOCK_DATA) {
        ...
        // Логирование данных не требуется в production
                  ...
                  >
                    ...
                    <div className="best-option-content">
                      ...
                      <div className="best-option-stats">
                        {option.square !== null && option.square !== undefined && (
                        ...
                        {option.analyticsResponse?.annualPriceChangePercent !== null && option.square !== undefined && (
                          <div className="best-stat-item highlight">
                        ...
                        {option.analyticsResponse?.threeMonthPriceChangePercent !== null && option.square !== undefined && (
                          <div className="best-stat-item">
