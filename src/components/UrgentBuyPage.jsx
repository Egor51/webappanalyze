...
const UrgentBuyPage = ({ onNavigateToSearch, onNavigateToInvesting }) => {
  ...
  return (
    <div className="urgent-buy-page">
        ...
        <div className="urgent-buy-hero-content">
          ...
          <div className="urgent-buy-cta-buttons">
            ...
            >
              ...
              <span>Оставить заявку на срочную продажу</span>
            </button>
            <button 
      ...
      <section className="urgent-buy-evaluation">
        <div className="evaluation-card">
          <div className="evaluation-content">
            <h2 className="evaluation-title">Точная оценка на основе реальной аналитики — наше ключевое отличие</h2>
            ...
            >
              ...
              <span>Рассчитать ориентировочную цену сейчас</span>
            </button>
          </div>
      ...
      {/* Плавающая кнопка CTA (только на мобильных) */}
      <button 
        className="urgent-buy-floating-cta"
        onClick={scrollToForm}
